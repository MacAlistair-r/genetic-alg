...
Task.prototype.run = function (callback) {
  ...
  function (cb) { self.elitismStep(cb); }, // Add this line
...
Task.prototype.init = function (callback) {
  ...
  async.until(function () {
    ...
    function (callback) { self.getRandomSolution(function (solution) { self.population.push(solution); callback() }) }, function (err) {
